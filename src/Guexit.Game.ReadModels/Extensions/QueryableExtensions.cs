...
{
    public static async Task<PaginatedCollection<T>> PaginateAsync<T>(this IQueryable<T> queryable, 
        PaginationSettings paginationSettings, CancellationToken ct = default)
    {
