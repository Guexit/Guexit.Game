...
namespace Guexit.Game.Persistence.Npgsql.Migrations
{
    ...
    [Migration("20240618175009_AddIndexInGameRoomCreationDate")]
    partial class AddIndexInGameRoomCreationDate
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Guexit.Game.Domain.Model.GameRoomAggregate.CardReRoll", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("CardReRolls", (string)null);
                });
            ...
            modelBuilder.Entity("Guexit.Game.Domain.Model.GameRoomAggregate.Card", b =>
                {
                    b.HasOne("Guexit.Game.Domain.Model.GameRoomAggregate.CardReRoll", null)
                        .WithMany("ReservedCards")
                        .HasForeignKey("CardReRollId")
            ...
            modelBuilder.Entity("Guexit.Game.Domain.Model.GameRoomAggregate.GameRoom", b =>
                {
                    b.OwnsMany("Guexit.Game.Domain.Model.PlayerAggregate.PlayerId", "PlayerIds", b1 =>
                        {
                            ...
                            b1.HasKey("GameRoomId", "Value");

                            b1.HasIndex("Value");

                            b1.ToTable("GameRoomPlayers", (string)null);
            ...
            modelBuilder.Entity("Guexit.Game.Domain.Model.ImageAggregate.Image", b =>
                {
                    b.OwnsMany("Guexit.Game.Domain.Model.ImageAggregate.Tag", "Tags", b1 =>
                        {
                            b1.Property<Guid>("Id")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Guexit.Game.Domain.Model.GameRoomAggregate.GameRoom", b =>
                {
                    b.Navigation("CurrentCardReRolls");
