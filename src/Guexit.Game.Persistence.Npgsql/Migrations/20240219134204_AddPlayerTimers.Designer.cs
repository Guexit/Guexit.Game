...
namespace Guexit.Game.Persistence.Npgsql.Migrations
{
    ...
    [Migration("20240219134204_AddPlayerTimers")]
    partial class AddPlayerTimers
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Guexit.Game.Domain.Model.GameRoomAggregate.GameRoom", b =>
                {
                    b.OwnsMany("Guexit.Game.Domain.Model.GameRoomAggregate.PlayerTimer", "PlayerTimers", b1 =>
                        {
                            b1.Property<Guid>("Id")
                                .HasColumnType("uuid");
                            ...
                            b1.ToTable("PlayerTimers", (string)null);

                            b1.WithOwner()
                                .HasForeignKey("GameRoomId");
                        });

                    b.Navigation("PlayerTimers");
                });
